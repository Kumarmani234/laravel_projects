...
class AuthenticatedSessionController extends Controller
{
    ...
    public function store(LoginRequest $request): RedirectResponse
    {
        ...
        //  $Body=response()->{'email':'donseenu@scoriait.com'};

    //     //---------$request->authenticate();

    //     //call API http://scoriait.api.com/api/login for Authentication & Authorization

    //     $response = Http::post('http://scoriait.api.com/api/login',['body'=>$inputBody]);
...
$client = new Client();
$res = $client->request('POST', 'http://xsilica.api.com/api/login', [
    'headers' => [
      'Accept' => 'application/json',
      'content-type' => 'application/json',
