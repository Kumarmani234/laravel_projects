...
class studentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('students.index')->with('success','Employee data added successfully');
    }
    ...
    public function update(Request $request, Student $student)
    {
        ...
        // return redirect()->route('students.index')->with('success', 'Employee data has been updated successfully');
    ...
    public function destroy(Student $student)
    {
        ...
        return redirect()->route('students.index')->with('success', 'Employee data deleted successfully');
    }
}
