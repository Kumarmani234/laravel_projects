...
<div class="card-body">
    <form method="post" action="{{route('students.store')}}" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
        <label class="col-sm-2 col-label-form">Student Rollno</label>
        <div class="col-sm-10">
        ...
        <div class="row mb-4">
        <label class="col-sm-2 col-label-form">Student Marks</label>
        <div class="col-sm-10">
        <input type="text" name="student_marks" class="form-control"/>
        </div>
        </div>
