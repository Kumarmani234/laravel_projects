    ...
    <div class="card-body">
        <form method="post" action="{{route('students.update' , $student->id)}}" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" name="student_rollno" class="form-control " value="{{$student->student_rollno}}"/>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input class="text" name="student_marks" class="form-control" value="{{$student->student_marks}}"/>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input class="text" name="student_address" class="form-control" value="{{$student->student_address}}"/>
                </div>
            </div>
